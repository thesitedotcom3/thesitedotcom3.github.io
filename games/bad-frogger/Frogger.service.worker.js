...
/** @type {string} */
const CACHE_VERSION = '1775568218|160618513';
/** @type {string} */
const CACHE_PREFIX = 'Frogger-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Frogger.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Frogger.html","Frogger.js","Frogger.offline.html","Frogger.icon.png","Frogger.apple-touch-icon.png","Frogger.audio.worklet.js","Frogger.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Frogger.wasm","Frogger.pck"];
